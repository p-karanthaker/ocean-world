...
/**
 * OptionView sets up a JDialog in a GridLayout and displays all JSpinner items
 * which allow the user to edit the ModelConstants in a friendly way.
 * 
...
public class OptionsView extends JDialog {
	...
	/**
	 * List to hold all JSpinner objects which allow editing to all
	 * ModelConstants fields
	 */
	...
	/**
	 * Constructor to create the OptionsView object. Sets the layout, adds all
	 * items, and configures JDialog settings.
	 */
	public OptionsView() {
	 ...
	 * 
	 * @param frame
	 *            the frame in which to pop up message dialogs
	 */
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane
						.showMessageDialog(frame,
								"Press Menu > Restart Simulation for the new changes to take effect.");
				dispose();
			}
		});
	...
	/**
	 * Sets the configuration fields in ModelConstants with new values input by
	 * user
	 */
	private void setConfigParams() {
		...
		ModelConstants.CREATION_ODDS_SHARK = (Double) spinners.get(4)
				.getValue();
		ModelConstants.BREEDING_ODDS_SHARK = (Double) spinners.get(5)
				.getValue();
		ModelConstants.MAXIMUM_AGE_SHARK = (Integer) spinners.get(6).getValue();
		ModelConstants.BREEDING_AGE_SHARK = (Integer) spinners.get(7)
				.getValue();
		ModelConstants.CREATION_ODDS_SARDINE = (Double) spinners.get(8)
				.getValue();
		ModelConstants.BREEDING_ODDS_SARDINE = (Double) spinners.get(9)
				.getValue();
		ModelConstants.MAXIMUM_AGE_SARDINE = (Integer) spinners.get(10)
				.getValue();
		ModelConstants.BREEDING_AGE_SARDINE = (Integer) spinners.get(11)
				.getValue();
		ModelConstants.NUTRITIONAL_VALUE_SARDINE = (Integer) spinners.get(12)
				.getValue();
		ModelConstants.CREATION_ODDS_PLANKTON = (Double) spinners.get(13)
				.getValue();
		ModelConstants.BREEDING_ODDS_PLANKTON = (Double) spinners.get(14)
				.getValue();
		ModelConstants.MAXIMUM_AGE_PLANKTON = (Integer) spinners.get(15)
				.getValue();
		ModelConstants.BREEDING_AGE_PLANKTON = (Integer) spinners.get(16)
				.getValue();
		ModelConstants.NUTRITIONAL_VALUE_PLANKTON = (Integer) spinners.get(17)
				.getValue();
	}
	...
	public void buildComponents() {
		...
		JLabel lblSardineNutritionalValue = new JLabel(
		...
		JLabel lblPlanktonNutritionalValue = new JLabel(
				"Plankton Nutritional Value");
		labels.add(lblPlanktonNutritionalValue);

		JSpinner spinSimulationLenth = new JSpinner(new SpinnerNumberModel(
				ModelConstants.SIMULATION_LENGTH, 100, 10000, 1));
		spinners.add(spinSimulationLenth);

		JSpinner spinRNGSeed = new JSpinner(new SpinnerNumberModel(
				ModelConstants.RNG_SEED, 1, 1000, 1));
		spinners.add(spinRNGSeed);

		JSpinner spinOceanWidth = new JSpinner(new SpinnerNumberModel(
				ModelConstants.OCEAN_WIDTH, 50, 500, 5));
		spinners.add(spinOceanWidth);

		JSpinner spinOceanDepth = new JSpinner(new SpinnerNumberModel(
				ModelConstants.OCEAN_DEPTH, 50, 500, 5));
		spinners.add(spinOceanDepth);

		JSpinner spinSharkCreationOdds = new JSpinner(new SpinnerNumberModel(
				ModelConstants.CREATION_ODDS_SHARK, 0.01, 1, 0.01));
		spinners.add(spinSharkCreationOdds);

		JSpinner spinSharkBreedingOdds = new JSpinner(new SpinnerNumberModel(
				ModelConstants.BREEDING_ODDS_SHARK, 0.01, 1, 0.01));
		spinners.add(spinSharkBreedingOdds);

		JSpinner spinSharkMaximumAge = new JSpinner(new SpinnerNumberModel(
				ModelConstants.MAXIMUM_AGE_SHARK, 0, null, 1));
		spinners.add(spinSharkMaximumAge);

		JSpinner spinSharkBreedingAge = new JSpinner(new SpinnerNumberModel(
				ModelConstants.BREEDING_AGE_SHARK, 0, null, 1));
		spinners.add(spinSharkBreedingAge);

		JSpinner spinSardineCreationOdds = new JSpinner(new SpinnerNumberModel(
				ModelConstants.CREATION_ODDS_SARDINE, 0.01, 1, 0.01));
		spinners.add(spinSardineCreationOdds);

		JSpinner spinSardineBreedingOdds = new JSpinner(new SpinnerNumberModel(
				ModelConstants.BREEDING_ODDS_SARDINE, 0.01, 1, 0.01));
		spinners.add(spinSardineBreedingOdds);

		JSpinner spinSardineMaximumAge = new JSpinner(new SpinnerNumberModel(
				ModelConstants.MAXIMUM_AGE_SARDINE, 0, null, 1));
		spinners.add(spinSardineMaximumAge);

		JSpinner spinSardineBreedingAge = new JSpinner(new SpinnerNumberModel(
				ModelConstants.BREEDING_AGE_SARDINE, 0, null, 1));
		spinners.add(spinSardineBreedingAge);

		JSpinner spinSardineNutritionalValue = new JSpinner(
				new SpinnerNumberModel(
						ModelConstants.NUTRITIONAL_VALUE_SARDINE, 0, null, 1));
		spinners.add(spinSardineNutritionalValue);

		JSpinner spinPlanktonCreationOdds = new JSpinner(
				new SpinnerNumberModel(ModelConstants.CREATION_ODDS_PLANKTON,
						0.01, 1, 0.01));
		spinners.add(spinPlanktonCreationOdds);

		JSpinner spinPlanktonBreedingOdds = new JSpinner(
				new SpinnerNumberModel(ModelConstants.BREEDING_ODDS_PLANKTON,
						0.01, 1, 0.01));
		spinners.add(spinPlanktonBreedingOdds);

		JSpinner spinPlanktonMaximumAge = new JSpinner(new SpinnerNumberModel(
				ModelConstants.MAXIMUM_AGE_PLANKTON, 0, null, 1));
		spinners.add(spinPlanktonMaximumAge);

		JSpinner spinPlanktonBreedingAge = new JSpinner(new SpinnerNumberModel(
				ModelConstants.BREEDING_AGE_PLANKTON, 0, null, 1));
		spinners.add(spinPlanktonBreedingAge);

		JSpinner spinPlanktonNutritionalValue = new JSpinner(
				new SpinnerNumberModel(
						ModelConstants.NUTRITIONAL_VALUE_PLANKTON, 0, null, 1));
