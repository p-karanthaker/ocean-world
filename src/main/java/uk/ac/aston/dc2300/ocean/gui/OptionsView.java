...
public class OptionsView extends JDialog {
	...
	public void buildComponents() {
		...
		JSpinner spinSimulationLenth = new JSpinner(
				new SpinnerNumberModel(ModelConstants.SIMULATION_LENGTH, 100, Integer.MAX_VALUE, 1));
		spinners.add(spinSimulationLenth);

		JSpinner spinRNGSeed = new JSpinner(new SpinnerNumberModel(ModelConstants.RNG_SEED, 1, Integer.MAX_VALUE, 1));
		...
		JSpinner spinSharkCreationOdds = new JSpinner(
				new SpinnerNumberModel(ModelConstants.CREATION_ODDS_SHARK, 0.01, 1, 0.01));
		spinners.add(spinSharkCreationOdds);

		JSpinner spinSharkBreedingOdds = new JSpinner(
				new SpinnerNumberModel(ModelConstants.BREEDING_ODDS_SHARK, 0.01, 1, 0.01));
		spinners.add(spinSharkBreedingOdds);

		JSpinner spinSharkMaximumAge = new JSpinner(
				new SpinnerNumberModel(ModelConstants.MAXIMUM_AGE_SHARK, 0, Integer.MAX_VALUE, 1));
		spinners.add(spinSharkMaximumAge);

		JSpinner spinSharkBreedingAge = new JSpinner(
				new SpinnerNumberModel(ModelConstants.BREEDING_AGE_SHARK, 0, Integer.MAX_VALUE, 1));
		spinners.add(spinSharkBreedingAge);

		JSpinner spinSardineCreationOdds = new JSpinner(
				new SpinnerNumberModel(ModelConstants.CREATION_ODDS_SARDINE, 0.01, 1, 0.01));
		spinners.add(spinSardineCreationOdds);

		JSpinner spinSardineBreedingOdds = new JSpinner(
				new SpinnerNumberModel(ModelConstants.BREEDING_ODDS_SARDINE, 0.01, 1, 0.01));
		spinners.add(spinSardineBreedingOdds);

		JSpinner spinSardineMaximumAge = new JSpinner(
				new SpinnerNumberModel(ModelConstants.MAXIMUM_AGE_SARDINE, 0, Integer.MAX_VALUE, 1));
		spinners.add(spinSardineMaximumAge);

		JSpinner spinSardineBreedingAge = new JSpinner(
				new SpinnerNumberModel(ModelConstants.BREEDING_AGE_SARDINE, 0, Integer.MAX_VALUE, 1));
		spinners.add(spinSardineBreedingAge);

		JSpinner spinSardineNutritionalValue = new JSpinner(
				new SpinnerNumberModel(ModelConstants.NUTRITIONAL_VALUE_SARDINE, 0, Integer.MAX_VALUE, 1));
		spinners.add(spinSardineNutritionalValue);

		JSpinner spinPlanktonCreationOdds = new JSpinner(
				new SpinnerNumberModel(ModelConstants.CREATION_ODDS_PLANKTON, 0.01, 1, 0.01));
		spinners.add(spinPlanktonCreationOdds);

		JSpinner spinPlanktonBreedingOdds = new JSpinner(
				new SpinnerNumberModel(ModelConstants.BREEDING_ODDS_PLANKTON, 0.01, 1, 0.01));
		spinners.add(spinPlanktonBreedingOdds);

		JSpinner spinPlanktonMaximumAge = new JSpinner(
				new SpinnerNumberModel(ModelConstants.MAXIMUM_AGE_PLANKTON, 0, Integer.MAX_VALUE, 1));
		spinners.add(spinPlanktonMaximumAge);

		JSpinner spinPlanktonBreedingAge = new JSpinner(
				new SpinnerNumberModel(ModelConstants.BREEDING_AGE_PLANKTON, 0, Integer.MAX_VALUE, 1));
		spinners.add(spinPlanktonBreedingAge);

		JSpinner spinPlanktonNutritionalValue = new JSpinner(
				new SpinnerNumberModel(ModelConstants.NUTRITIONAL_VALUE_PLANKTON, 0, Integer.MAX_VALUE, 1));
