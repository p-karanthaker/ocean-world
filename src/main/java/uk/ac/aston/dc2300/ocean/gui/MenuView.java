...
/**
 * MenuView sets up a JMenuBar with predefine defined items and actions which
	...
	public static JMenuBar createMenuBar(final JFrame parent) {
		...
		restartSimulationItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				/*
				 * Create a new Simulator object which runs in a new Thread so
				 * that it is not executed in the Event Dispatch Thread. This
