...
public class FieldStats {
	// Counters for each type of entity (plankton, sardine, etc.) in the
	// simulation.
	...
	/**
	 * Generate counts of the number of creatures. These are not kept up to date
	 * as creatures are placed in the field, but only when a request is made for
	 * the information.
	 */
