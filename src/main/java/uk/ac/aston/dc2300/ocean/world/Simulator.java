...
public class Simulator {
	...
	/**
	 * Random object used for selection with probabilities and preventing
	 * observed behaviour
	 */
	...
	/**
	 * Constructor for the Simulator. Initialised various fields, sets the
	 * colours of the animals, and adds a JMenuBar to the view.
	 * 
	 * @param depth
	 *            the depth of the simulation field
	 * @param width
	...
	/**
	 * Populates the field with creatures randomly based on their creation
	 * probability.
	 */
	public void populate() {
		...
		for (int depth = 0; depth < field.getDepth(); depth++) {
			for (int width = 0; width < field.getWidth(); width++) {
				// Use a random number generator to decide what creature to
				// create
	...
	/**
	 * Simulates the ocean field and all activity for the pre-defined number of
	 * steps
	 */
