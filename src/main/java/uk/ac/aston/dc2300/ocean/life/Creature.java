...
abstract public class Creature {
	...
	/**
	 * Performs the basic actions that all creatures share the same
	 * implementation of
	 * 
	 * @param field
	 ...
	 * @param field
	 *            the current 2D array representing the environment
	 * @return a baby creature created at a location adjacent to the parent
	 *         creature
	 */
	...
	/**
	 * @return the max age the creature can reach before death by old age
	 */
	abstract public int getMaxAge();

	/**
	 * @return the minimal age the creature can be at before breeding is
	 *         possible for it
	 */
	abstract public double getBreedingAge();

	/**
	 * @return how much the food level of a creature will increase if it is
	 *         capable and eats this creature
	 */
	...
	/**
	 * @param age
	 *            the age to set for the Creature
	 */
	...
	/**
	 * @param location
	 *            the location to set for the Creature
	 */
